...
// Vendored for JT Power Tools — wrapped in IIFE and exposed as window.JTFinder
// (no module loader available in this Chrome extension; ES module syntax replaced).
(function () {
let config;
let rootDocument;
let start;
