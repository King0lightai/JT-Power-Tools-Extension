          ...
          <div class="jt-alert-modal-body">
            ...
            <div class="jt-alert-message-container">
              <div class="jt-alert-toolbar jt-responsive-toolbar">
                ...
                <button type="button" class="jt-toolbar-item" data-format="bullet" title="Bullet List">${JTIcons.markup('bullet')}</button>
                <button type="button" class="jt-toolbar-item" data-format="numbered" title="Numbered List">${JTIcons.markup('numbered')}</button>
                ...
                <button type="button" class="jt-toolbar-item" data-format="link" title="Insert Link">${JTIcons.markup('link')}</button>
                <button type="button" class="jt-toolbar-item" data-format="quote" title="Quote">${JTIcons.markup('quote')}</button>
                <button type="button" class="jt-toolbar-item" data-format="hr" title="Horizontal Rule (---)">${JTIcons.markup('hr')}</button>
              </div>
